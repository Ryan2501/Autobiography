...
class screen1 extends StatelessWidget {
  ...
  final String s1='大家好，我是一位來自普通家庭的孩子，生長在一個平凡而溫馨的家庭裡。'
                  '我的父親是一位勤奮的計程車司機，而母親則在一家加油站擔任員工，他們的辛勤工作為我們的生活打下了堅實的基礎。'
                  '我出生在一個充滿愛的家庭，父母雖然工作辛苦，但總是用笑容和關愛滿足著我們的需求。父親的計程車成了我童年的象徵，'
                  '他開著那輛明亮的車子，總是溫暖地接送我們到學校、朋友家，無論風雨晴雪，他總是守護在我們身邊。他的堅持和努力工作的精神深深影響著我，讓我懂得了奮鬥和堅持的價值。'
                  '母親在加油站的工作也給了我很多啟發。她總是精明地應對各種工作上的挑戰，並用她的智慧和毅力為家庭付出。她教導我們節約的觀念，讓我們懂得生活的不易，更懂得珍惜每一分每一秒。'
                  '她的細心和愛心也使我們感受到家的溫暖，讓我們在成長過程中充滿自信和愛。'
                  '我的成長過程中充滿了父母的愛和教導。他們雖然沒有豐富的物質條件，但用心呵護著我們，讓我們感受到無盡的溫暖。'
                  '我學到了努力拼搏的精神，學到了在困難面前堅持不懈的毅力。父親的計程車和母親的加油站工作雖然看似平凡，'
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text('楊仁和的自傳', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
          ),
          //自傳部份
          Container(
      ...
      child: Center(
        child: Container(
          ...
          child: Align(
            ...
            child: Text(
              '''我的學習歷程始於中山國小，那裡是我接觸知識的起點。老師的悉心教導和同學之間的友誼，讓我對學習產生濃厚的興趣。隨著時光流轉，我進入了彰興國中，開始接觸更多元的學科和活動。在這段期間，我不僅學到了更多的知識，還參與了各種社團和課外活動，激發了我對不同領域的探索心情。老師的啟發和同學的合作，讓我在學業和人際方面都有了全面的成長。轉眼間，高中階段的選擇即將開始。我選擇了彰師附工，這是一所以科技為主的學校，提供了更多實務和專業的知識。在這裡，我深深感受到老師的專業和教學的實用性，這為我未來的發展打下了堅實的基礎。為了更進一步深造，我努力準備升學考試，最終成功考入了高科大。這是我學習歷程中的一個新里程碑，也是我對未來充滿期待的開始。在高科大，我將有更多的機會學到更深層次的知識，同時也能參與更多實際的專業項目。這一路走來，我的學習歷程充滿了努力、堅持和成長。我感謝家人的支持，感謝老師的教導，也感謝身邊的同學們一路相伴。未來，我將繼續保持對學習的熱忱，不斷挑戰自己，為實現更大的夢想而努力拼搏。這段豐富多彩的學習歷程將成為我人生中珍貴的一部分，為我迎接未來的挑戰打下堅實的基礎。''',
